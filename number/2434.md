## [LeetCode 2434](https://leetcode.com/problems/using-a-robot-to-print-the-lexicographically-smallest-string/) Using a Robot to Print the Lexicographically Smallest String (medium)
